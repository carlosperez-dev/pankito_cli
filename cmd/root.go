...
var rootCmd = &cobra.Command{
	Use:   "playita",
	Short: "Space repetition in the terminal",
	Long: `
Space repetition in the terminal.
For details on how the program works please visit: github.com/carlosperez-dev/playita_cli
	`,
